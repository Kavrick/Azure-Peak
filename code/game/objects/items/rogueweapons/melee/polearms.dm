...
/obj/item/rogueweapon/dscythe/getonmobprop(tag)
	. = ..()
	if(tag)
		switch(tag)
			if("gen")
				return list("shrink" = 0.5,"sx" = -9,"sy" = 0,"nx" = 11,"ny" = 1,"wx" = -4,"wy" = -1,"ex" = 3,"ey" = -1,"nturn" = -15,"sturn" = 28,"wturn" = -142,"eturn" = -28,"nflip" = 0,"sflip" = 8,"wflip" = 1,"eflip" = 0,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 0,)
			if("wielded")
